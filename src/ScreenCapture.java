...
public class ScreenCapture {
    ...
    public static String startScreenCapture() throws AWTException, IOException, SQLException {
        ...
        String fileName = formattedDate + "" + formattedTime + "" + username + ".png";
    ...
    public static void imagesToPdf() throws IOException, SQLException {
        ...
        String FontDirectoryPath = System.getProperty("user.dir") + "/src/assets/fonts/Satoshi-Regular.ttf";
        File fontFile = new File(FontDirectoryPath);
